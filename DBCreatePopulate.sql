...
INSERT INTO `tblmenu` (`iMenuID`, `vcTitle`, `vcLink`, `iReadPriv`, `iWritePriv`, `vcHeader`, `bAdmin`, `bNewWindow`, `bCont`, `bdel`, `bSecure`) VALUES
	...
	(73, 'CustomEmail.php', 'CustomEmail.php', 500, 300, 'CustomEmail.php', 0, 0, 0, 0, 0),
	...
	(88, 'signupConf.php', 'signupConf.php', 500, 300, 'signupConf.php', 0, 0, 0, 0, 0),
	...
	(91, 'update.php', 'update.php', 500, 300, 'update.php', 0, 0, 0, 0, 0),
